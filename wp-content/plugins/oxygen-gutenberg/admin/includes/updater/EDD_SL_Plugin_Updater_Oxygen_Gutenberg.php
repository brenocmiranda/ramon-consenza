 ...
 * @version 1.6
 */
class EDD_SL_Plugin_Updater_Oxygen_Gutenberg {
    private $api_url   = '';
    ...
    private function api_request( $_action, $_data ) {
        ...
        $request = get_transient('edd_get_version_'.$data['item_name'].$data['license']);
        ...
        if (false == $request) {
            ...
            set_transient('edd_get_version_'.$data['item_name'].$data['license'], $request, 60 * 60 * 3);
        }
